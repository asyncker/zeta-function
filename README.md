...
ptlim(12 * (2^n - 1) - 1) = {0, 1} | {1, 3, 4, 7, 9, 12, 15, 16, 25, 37, 40, 43, 49, 72, 75, 124, 180, 196, 208, 312, 480, 568, 1113, 1729...}

so many primes x^n * k - u:
ptlim(2^n * 24 - 24 - 1) = {0, 1} | {1, 2, 3, 4, 5, 6, 9, 10, 13, 14, 15, 18, 20, 26, 28, 30, 32, 33, 38, 55, 60, 63, 66, 79, 93, 96, 145, 154, 172, 193, 238, 264, 346, 391, 401, 411, 432, 453, 482, 495, 534, 545, 581, 712, 724, 762, 926, 1004, 1073...}
```
